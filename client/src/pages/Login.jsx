  ...
  return (
    <>
      <style>{`
        ...
        .auth-card { background: var(--ink-soft); border: 1px solid var(--line); border-radius: 20px; padding: 40px; width: 100%; max-width: 420px; box-shadow: 0 30px 60px rgba(0,0,0,0.5); position: relative; overflow: hidden; }
        .success-banner {
      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <h2 style={{ fontFamily: 'Fraunces, serif', fontSize: '2rem', marginBottom: '8px' }}>Welcome Back</h2>
          <p style={{ color: 'var(--cream-dim)', fontSize: '0.9rem', marginBottom: '24px' }}>Sign in to manage your flight bookings.</p>
          ...
          <p style={{ textAlign: 'center', marginTop: '20px', fontSize: '0.85rem', color: 'var(--cream-dim)' }}>
            Don't have an account? <Link to="/signup" style={{ color: 'var(--ember)', fontWeight: 600 }}>Register</Link>
          </p>
        </div>
      </div>
    </>
